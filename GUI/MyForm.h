...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Size = System::Drawing::Size(260, 161);
			this->textBox1->TabIndex = 1;
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(12, 209);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		{
			this->textBox1->Text = "\n\n opening file: " + this->openFileDialog1->FileName;
		}
		Console::WriteLine("file chooser closed");
	}
